...
JDL Monday; February 18, 2019
Add lines at EOF to support Leader Key support
...
/* Leader Key support added JDL, 300ms is more typical */
#define LEADER_TIMEOUT 350
/* lower timeout from 300 to 250 if per key timing enabled */
